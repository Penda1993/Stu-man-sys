<?php
	...
	{
		$b=mysqli_query($conn,"insert into student_login(`f_name`,`l_name`,`gender`,`email`,`address`,`province`,`city`,`zipcode`,`contact`,`password`,`img`,`course`,`due`) values('".$_POST['f_name']."','".$_POST['l_name']."','".$_POST['gender']."','".$_POST['email']."','".$_POST['address']."','".$_POST['province']."','".$_POST['city']."','".$_POST['zipcode']."','".$_POST['contact']."','".$_POST['password']."','".$_FILES['image']['name']."','".$_POST['course']."','50000')");
