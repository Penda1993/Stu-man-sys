...
<div class="container-fluid" style="height:500px;">
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			<center>
				<div id="container">
					<br>
					<center>
						<p style="font-size:30px;color:red;font-weight:bold;"><span style="color:black;">ABOUT</span> ALL STUDENT</p>
					</center>
					<br>
					<div class="container">
	...
	';
							?>
								<th>
									<form action="view_student_attendance.php" method="get">
										<input name="student_id" type="hidden" value="<?php echo $data['id'] ?>">
