<?php
	...
	{
		$b=mysqli_query($conn,"insert into teacher_login(`f_name`,`l_name`,`gender`,`email`,`address`,`province`,`city`,`zipcode`,`contact`,`password`,`img`) values('".$_POST['f_name']."','".$_POST['l_name']."','".$_POST['gender']."','".$_POST['email']."','".$_POST['address']."','".$_POST['province']."','".$_POST['city']."','".$_POST['zipcode']."','".$_POST['contact']."','".$_POST['password']."','".$_FILES['image']['name']."')");
