<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$r=mysqli_query($conn,"update parent_login set email='".$_POST['email']."',contact='".$_POST['contact']."'
	...
	$data=mysqli_fetch_assoc(mysqli_query($conn,"select * from parent_login where id='".$_SESSION['user_id']."'"));
?>
<html>
	<head>
	...
	<!--container start-->
		<div class="container " id="div">
			<br>
				<center><h1><span style="margin-bottom:-20px;color:red;">Edit Parent Information</span> Form</h1></center>
			...
			<div class="row">
				...
				<div class="col-9 p-5">
						...
						<div class="form-group has-search"><br>						
							...
							<input type="number" name="contact" class="form-control" placeholder="PhoneNo" id="form" value="<?php echo $data['contact'];?>" required>
						</div><br>
