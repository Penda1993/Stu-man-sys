<?php
	...
	$users=mysqli_fetch_assoc(mysqli_query($conn,"select * from parent_login where id='".$_SESSION['user_id']."'"));
?>	<div class="container-fluid" style="background:#fc9e05;height:100px;">
		
		<ul class="nav justify-content-end">
			<h3 style="padding:25px 300px 0px 0px;font-weight:bold;color:white;cursor:hand;" onclick="window.location.href='dashboard.php'">Welcome, <span style="color:purple;"><?php echo $users['f_name'];?></span></h3>
			<li class="nav-item">
