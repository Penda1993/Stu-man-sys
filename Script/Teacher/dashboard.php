...
//error_reporting(0);
	...
	$count=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM parent_login"));
	$count1=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM teacher_login"));
    $count2=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM sas_attendance"));
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div style="background: ; height: 120px;">
                <div class="form-group has-search" style="background: #00c0ef; border-radius: 10px; box-shadow: 2px 2px 20px #888888; height: 120px; width: 210px; float: left; margin-left: 40px; margin-right: 10px;">
                    ...
                    <div style="background: #00a3cb; height: 25px; margin-top: 105px; font-size: 12px; color: white; cursor: hand;" onclick="window.location.href='view_student.php'">
                        <center>more info<i></i></center>
                    </div>
                </div>
                <div class="form-group has-search"
                    onclick="window.location.href='view_parent.php'"
                ...
                >
                    <div style="float: left; width: 50%;">
                        ...
                        <p style="color: white; font-weight: ; font-size: 15px; margin-left: 15px;">Parents</p>
                    </div>
                    ...
                    <div style="background: #008d4d; height: 25px; margin-top: 105px; font-size: 12px; color: white; cursor: hand;" onclick="window.location.href='View_parent.php'"><center>more info</center></div>
                </div>
                <div
                    class="form-group has-search"
                    onclick="window.location.href='attend.php'"
                ...
                >
                    <div style="float: left; width: 50%;">
                        ...
                        <p style="color: white; font-weight: ; font-size: 15px; margin-left: 15px;">Attendance</p>
                    </div>
                    ...
                    <div style="background: #cf850f; height: 25px; margin-top: 105px; font-size: 12px; color: white; cursor: hand;" onclick="window.location.href='attend.php'"><center>more info</center></div>
                </div>
                <div
                    class="form-group has-search"
