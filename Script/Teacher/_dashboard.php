            ...
            <div class="row">
                ...
                <main role="main" class="col-md-8 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div
                        ...
                        <div
                            class="form-group has-search"
                            onclick="window.location.href='notofication.php'"
                        ...
                        >
                            <div style="float: left; width: 50%;">
                                ...
                                <p style="color: white; font-weight: ; font-size: 15px; margin-left: 15px;">Notifications</p>
                            </div>
                            ...
                            <div style="background: #cf850f; height: 25px; margin-top: 105px; font-size: 12px; color: white; cursor: hand;" onclick="window.location.href='notification.php'"><center>more info</center></div>
                        </div>
                </main>
            </div>
        </div>
