    ...
    <center>
        <div id="mydiv">
            ...
            <div id="div-1">
                ...
                <p id="mydata">Contact : <?php echo $stu['contact'];?></p><br><br>
                <p id="mydata">Address : <?php echo $stu['address'];?></p><br><br>
                <p id="mydata">Zipcode :<?php echo $stu['zipcode'];?></p><br><br>
                <p id="mydata" >Course : <?php echo $d['dept_name'];?></p><br><br>
                <p id="mydata">Parent : <?php echo $stu['parent'];?></p><br><br>
                <p id="mydata">Parent Contact :<?php echo $stu['parent_contact'];?></p><br>
            </div>
            <br>
