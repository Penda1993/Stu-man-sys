<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$r=mysqli_query($conn,"update teacher_login set email='".$_POST['email']."',contact='".$_POST['contact']."'
			...
			<div class="row">
				...
				<div class="col-9 p-5">
						...
						<div class="form-group has-search"><br>						
							...
							<input type="number" name="contact" class="form-control" placeholder="PhoneNo" id="form" value="<?php echo $t['contact'];?>" required>
						</div><br>
